...
# [GCC 4.8.4]
# Embedded file name: /home/docker/code/gstudio/gnowsys-ndf/gnowsys_ndf/ndf/management/commands/node_import.py
# Compiled at: 2018-01-01 16:38:44
"""
            ...
            if triple_obj:
                ...
                if triple_obj._type == 'GRelation':
                    if triple_obj.right_subject != triple_json['right_subject']:
                        ...
                        triple_collection.collection.update({'subject': triple_obj.subject,'relation_type': triple_json['relation_type'],'_id': {'$ne': triple_obj._id}}, {'$set': {'status': u'DELETED'}}, multi=True, upsert=False)
