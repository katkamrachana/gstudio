...
# [GCC 4.8.4]
# Embedded file name: /home/docker/code/gstudio/gnowsys-ndf/gnowsys_ndf/ndf/management/commands/group_export.py
# Compiled at: 2018-01-04 16:01:24
...
def update_globals():
    ...
    GLOBAL_DICT = {'GROUP_CONTRIBUTORS': GROUP_CONTRIBUTORS,
       'DUMP_PATH': DUMP_PATH,
       'TOP_PATH': TOP_PATH,
       'GROUP_ID': GROUP_ID,
        ...
        if dump_node_obj:
            ...
            if dump_node_obj._type == 'Group':
                ...
                if confirm_non_grp_exp in ('y', 'Y'):
                    MULTI_DUMP = True
                    module_units_cur = node_collection.find({'_id': {'$in': dump_node_obj.collection_set},'_type': 'Group'
                       })
