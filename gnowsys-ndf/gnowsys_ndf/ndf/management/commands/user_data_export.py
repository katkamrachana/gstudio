...
# [GCC 4.8.4]
# Embedded file name: /home/docker/code/gstudio/gnowsys-ndf/gnowsys_ndf/ndf/management/commands/user_data_export.py
# Compiled at: 2018-01-05 11:47:33
import os, datetime
try:
...
def update_globals():
    ...
    GLOBAL_DICT = {'DUMP_PATH': DUMP_PATH,
       'TOP_PATH': TOP_PATH,
        ...
        if proceed_flag:
            try:
                ...
                rec = node_collection.collection.aggregate([{'$match': query},
                 {'$group': {'_id': 0,
                               'count': {'$sum': 1},'author_set': {'$addToSet': '$author_set'
                                              },
                               'group_admin': {'$addToSet': '$group_admin'
                                               }
                               }
                    },
                 {'$project': {'_id': 0,
